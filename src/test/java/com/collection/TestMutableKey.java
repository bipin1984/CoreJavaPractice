...
public class TestMutableKey {
	...
	public static void main(String[] args) {
        ...
        HashMap<HashMapCustomerKey, String> map = new HashMap<HashMapCustomerKey, String>();
          
        //Create key 1
        HashMapCustomerKey a1 = new HashMapCustomerKey(1);
        a1.setHolderName("A_ONE");
        //Create key 2
        HashMapCustomerKey a2 = new HashMapCustomerKey(2);
        ...
        HashMapCustomerKey a3 = new HashMapCustomerKey(1);
